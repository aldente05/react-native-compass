package com.welvarend.sensor;

/**
 * Created by f.putra on 30/11/17.
 */
...
public class MotionValue implements SensorEventListener {
    ...
    public MotionValue(ReactApplicationContext reactContext) {
